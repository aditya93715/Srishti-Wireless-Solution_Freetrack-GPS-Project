          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{
                ...
                {selectedHex.toUpperCase()}{selectedObj ? ` · ${selectedObj.group}` : " · Custom"}
              </div>
            </div>
          </div>
            ...
            {isSaving ? (
              <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 11, color: "#6B7280" }}>
                <div style={{
                  ...
                  height: 11,
                  borderRadius: "50%",
                  border: `2px solid ${selectedHex}30`,
                  borderTopColor: selectedHex,
